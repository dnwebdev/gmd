...
tjq(window).load(function() {
    ...
    if (enableChaser == 1 && tjq('#content').length > 0 && tjq('#main-menu ul.menu').length > 0) {
        ...
        tjq('<h1 class="logo navbar-brand"><a title="Gomodo" href="/"><img alt="" src="'+window.location.origin+'/explore-assets/images/logo.png" style="width: 50px!important;"><span class="gomodo_text" style="color: #b5b5b4">GOMODO</span></a></h1>').insertBefore('.chaser .menu');
