...
var Dashboard = function () {
    ...
    return {
        ...
        circleOnly : function () {
            _CampaignStatusDonutChart('#campaign-status-pie-hnd', 500);
        }
    }
}();
...
$(document).one('click', '#tab-with-graph-line', function() {
...
$(document).one('click', '#tab-with-graph-circle', function() {
    Dashboard.initComponents();
    setTimeout(function () {
        Dashboard.circleOnly();
    }, 1000);
