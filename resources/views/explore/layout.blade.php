...
<head>
    ...
    @if(isset($seo) && $seo!==null)
        ...
        <meta property="og:image" content="{{asset('landing/img/Logo.png')}}"/>
...
@else{{$tag->tagBlogPost->tag_name_eng}},@endif
    ...
    @else
        ...
        <meta name="keywords" content="Gomodo market place"/>
        <meta name="description" content="Gomodo market place">
        <meta name="author" content="Gomodo market place">
    @endif
...
<!-- Meta Tags -->
    ...
    <link rel="shortcut icon" href="{{asset('explore-assets/favicon.ico')}}" type="image/x-icon">
    <!-- Theme Styles -->
...
<script type="text/javascript" src="{{asset('explore-assets/js/theme-scripts.js')}}"></script>
