                            ...
                            @if($order->payment->payment_gateway =='Xendit Credit Card')
                                <tr>
                                    <td>
                                        ...
                                        ({{ $payment->type == 'percentage' ? $payment->pricing_primary .'%' : 'IDR '. $payment->pricing_primary }}
                                        )
                                    </td>
                                    <td class="text-right bold">
        ...
        <div class="container py-3">
            <div class="row">
                <div class="col-12 text-right">
                    @if($order->status =='0')
                        @if(in_array($order->payment->payment_gateway, ['Xendit Virtual Account', 'Xendit Virtual Account OVO', 'Xendit Credit Card']))
