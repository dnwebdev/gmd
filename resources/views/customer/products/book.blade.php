                            ...
                            <div class="insurance-wrapper">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9 mt-3 mt-md-0">
                                                ...
                                                <div class="custom-control  custom-switch">
                                                    ...
                                                    <label class="custom-control-label " for="customSwitch1">{!! trans('customer.book.insurance.use') !!}</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row insurance-content" style="display: none">
                                    <div class="col-12 mt-3">
                                        <h3>{!! trans('customer.book.insurance.input_your_info') !!}</h3>
                                        <p class="small">{!! trans('customer.book.insurance.quantity') !!}: {{ $pax}}</p>
                                    </div>
                                    <div class="col-12 mt-3">
                                        <h3>{!! trans('customer.book.insurance.customer') !!}</h3>
                                    </div>
                                    <div class="col-12">
                                        <div class="row">
                                                    ...
                                                    <div class="md-form __parent_form">
                                                        @switch($customerForm->type)
                                                            ...
                                                            <div class="md-form __parent_form">
                                                                ...
                                                                <label for="insurances-{{$insurance->id}}-customer-{{$customerForm->name}}">{{$customerForm->label}}</label>
                                                            </div>
                                                            @break
                                                            @case('textarea')
                                                            <div class="md-form __parent_form">
                                    ...
                                    <div class="col-12 mt-3 col-participants">
                                        <div class="row">
                                            @for($i=1;$i<=$pax;$i++)
                                                ...
                                                <div class="col-md-6">
                                                    <h3>{!! trans('customer.book.insurance.participant') !!} {{$i}}</h3>
                                                            ...
                                                            @switch($customerForm->type)
                                                                ...
                                                                <div class="md-form __parent_form">
                                                                    <input type="text" id="insurances-{{$insurance->id}}-participants-{{$i}}-{{$customerForm->name}}"
                                                                           class="{{$customerForm->class}}"
                                                                           name="{{$name}}">
                                                                    <label for="insurances-{{$insurance->id}}-participants-{{$i}}-{{$customerForm->name}}">{!! $customerForm->label !!} </label>
                                                                </div>
                                                                @break
                                                                @case('date')
                                                                <div class="md-form __parent_form">
                    ...
                    <div class="card-header h-auto bg-style-1 py-2 px-3 additional-info-2" role="tablist"
                        ...
                        <ul class="nav nav-tabs card-header-tabs">
                            @for ($i = 0; $i < $total_tab; $i++)
                                <li class="nav-item">
                                    <a class="nav-link rounded-0{{ $i == 0 ? ' active' : '' }}" id="add{{ $i }}-tab"
                                       data-toggle="tab" href="#add{{ $i }}" role="tab" aria-controls="add{{ $i }}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="additional-info-2"
                            ...
                            <div class="tab-content p-0" id="nav-tabContent">
                                @for ($i = 0; $i < $total_tab; $i++)
                                    <div class="tab-pane fade{{ $i == 0 ? ' show active' : '' }}" id="add{{ $i }}"
                                         role="tabpanel" aria-labelledby="add{{ $i }}-tab">
                                        <div class="row">
                                            @php
                                                ...
                                                <div class="col-md-{{ $custom->type_custom == 'textarea' ? '12' : '6' }} mb-2">
                                                    <div class="{{ !in_array($custom->type_custom, ['dropdown', 'country', 'state', 'city']) ? 'md-form __parent_form' : '' }}">
                                                        @switch($custom->type_custom)
                                                            @case('choices')
                                                            @case('checkbox')
                                                            <div id="custom-{{ $i }}-{{ $custom->id }}" class="d-block">
                                                            ...
                                                            @break
                                                            @case('document')
                                                            <div class="mb-1"><strong>{{ $custom->label_name }}</strong>
                                                            </div>
                                                            <div class="mb-1"><small>{{ $custom->description }}</small>
                                                            </div>
                                                            <input type="file" id="custom-{{ $i }}-{{ $custom->id }}"
                                                            ...
                                                            @break
                                                            @case('photo')
                                                            <div id="custom-{{ $i }}-{{ $custom->id }}" class="mb-1">
                                                                <strong>{{ $custom->label_name }}</strong></div>
                                                            <div class="mb-1"><small>{{ $custom->description }}</small>
                                                            </div>
                                                            <div class="row">
                                                            ...
                                                            @break
                                                            @default
                                                            <input type="text" id="custom-{{ $i }}-{{ $custom->id }}"
                    ...
                    <table class="table table-borderless tbl-no-padding">
                        <tr>
                            ...
                            <td class="text-right bold fs-20" id="grandTotal">
                                @if ($product->vat)
                                    {{$product->currency }} {{ number_format($pricing['grand_total'] + ($pricing['grand_total'] * 10 / 100), 0, '', '.') }}
                                @else
        ...
        function calculatePricing() {
            ...
            if(charge_to === '1'){
                if(dataCard.attr('id') === 'percentage'){
					let tambahan = (grand/100)*dataCard.val();
					change.additional = tambahan;
