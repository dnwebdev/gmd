                                        ...
                                        <div class="card mt-1 mb-1">
                                            <div class="card-header"
                                                ...
                                                <h5 class="btn btn-link" type="button" data-toggle="collapse"
                                                    ...
                                                    <img width="120px" class="img-fluid"
                                                         src="{{asset('img/static/payment/dana.png')}}" alt="">
                                                </h5>
                                            ...
                                            <div id="collapseOne"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <h3>{!! trans('customer.dana.title') !!}</h3>
                                                    </div>
                                                    <div class="col-12">
                                                        <ol>
                                                            @foreach (trans('customer.dana.content') as $content)
                                                            <li>
                                                                {{$content}} 
                                                                @if ($loop->index === 0)
                                                                    <a href="{{ $order->payment->invoice_url }}" class="btn btn-sm btn-primary" target="_blank">{!! trans('customer.book.pay_now') !!}</a>
                                                                @endif
                                                            </li>
                                                            @endforeach
                                                        </ol>
...
@section('scripts')
    ...
    //   } else{
    //       $('#testimonials').css({"width":"100%","min-height":"1000px","border":"none","overflow-y":"hidden","overflow-x":"hidden"})
    //   }
