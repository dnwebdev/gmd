        ...
        <div class="widget card" id="order-guest">
          ...
          <div class="widget-content">
            <div class="row">
              ...
              <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                <button type="button" class="btn btn-success btn-sm btn-add modal-trigger" data-toggle="modal" data-target="#modalProduct">{{ trans('withdraw_provider.request_withdrawal') }}</button>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content col">
          ...
          <div class="modal-footer">
            ...
            <button class="modal-trigger btn btn-sm btn-success" >{{ trans('withdraw_provider.request_now') }}</button>
          </div>
        </div>
      </div>
    </form>
