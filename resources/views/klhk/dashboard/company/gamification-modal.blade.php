    ...
    <div class="row">
        <div class="col d-flex align-items-center mt-1">
            <div class="progress w-100">
                <div class="progress-bar gamification-progress-bar bg-teal" style="width: 0%">
                </div>
        ...
        <div class="col-md-auto mt-1">
            <button id="btn-show-gamification" type="button" class="btn bg-green-klhk legitRipple withdrawBtn w-100" data-toggle="modal" data-target="#gamificationModal">
        ...
        <div class="modal-body">
                ...
                <form action="" class="gamification" id="business_type_gamification">
                    <div class="step">
                        ...
                        <button type="submit" class="btn w-100 bg-green-klhk btn-next-step mt-3">{!! trans('gamification.general.submit') !!}</label>
                    </div>
                </form>
                ...
                <form action="" class="gamification" id="about_company_gamification">
                    <div class="step">
                        ...
                        <div class="row mt-3">
                            ...
                            <button type="submit" class="btn w-100 bg-green-klhk btn-next-step col-7 margin-auto">{!! trans('gamification.general.submit') !!}</label>
                        </div>
                    </div>
                </form>
                ...
                <form action="" class="gamification" id="address_company_gamification">
                    <div class="step">
                        {{-- <div class="form-group-feedback form-group-feedback-right mt-3">
                            <label>Negara</label>
                            <select class="form-control select2-general" data-placeholder="Masukkan Negara">
                ...
                <form action="" class="gamification" id="contact_us_gamification">
                    <div class="step">
                        ...
                        <h3 class="text-teal mt-3">{!! trans('gamification.contact-us.social-media') !!}</h3>
                ...
                <form action="" class="gamification" id="bank_account_gamification">
                    <div class="step">
                        <div class="form-group-feedback form-group-feedback-right mt-3">
                            ...
                            <select class="form-control select required" placeholder="{!! trans('gamification.bank-account.bank-name-placeholder') !!}" name="bank">
                                <option selected disabled>{{ trans('bank_provider.select_bank') }}</option>
                                @foreach (\App\Models\CompanyBank::$banks as $key => $value)
                                    <option {{auth()->user()->company->bank && auth()->user()->company->bank()->whereStatus(1)->latest()->first()->bank ==$key ?'selected':''}} value="{{ $key }}">
                                        {{ $value }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <h3 class="text-teal mt-3 text-center">{!! trans('gamification.bank-account.upload') !!}</h3>
                        <div class="form-group-feedback form-group-feedback-right mt-3">
                ...
                <form action="" class="gamification" id="finish_gamification">
                    <div class="step">
                        <div class="text-center">
                            <img src="{{ asset('klhk-asset/dest-operator/klhk-assets/img/gamify-success.svg') }}" alt="Success" class="img-fluid pt-3 pb-4">
                        </div>

                        <div class="row mt-3">
                            <button type="button" class="btn w-100 bg-green-klhk btn-success col-7 margin-auto" data-dismiss="modal">OK</button>
                        </div>
                    </div>
                </form>
