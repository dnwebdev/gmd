  ...
  <div class="container">
    <div class="row">
      <div class="col s12 m12 l12">
        <h5 class="breadcrumbs-title">Create New Banner</h5>
  ...
  <div class="row">
    <div class="col s12 m12 l12">
      <div class="card-panel">
        <h4 class="header2"><b>New Banner</b></h4>
        ...
        <div class="row">
          <form id="form_ajax" class="col s12" method="POST" action="{{ Route('company.banner.store') }}">
            ...
            <div class="row">
              <div class="input-field col s12 l12">
                <textarea name="description" type="text" length="300" class="materialize-textarea"></textarea>
