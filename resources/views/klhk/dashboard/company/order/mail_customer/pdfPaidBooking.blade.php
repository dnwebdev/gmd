        ...
        <td colspan="3">
            <table style="width: 100%;">
                ...
                @if($order->order_detail->fee_amount > 0)
                    <tr>
                        <td style="padding-left:  1.2rem!important;width:68%;">
                            Charge {{ $order->order_detail->fee_name }}</td>
                        <td><strong style="display: inline-flex;">IDR <span
                                        style="float: right;padding-right: 5%">{{ number_format($order->order_detail->fee_amount,0) }}</span></strong>
                        </td>
                    </tr>
                @endif
                ...
                @if($order->order_detail->discount_amount > 0)
                    <tr>
                        <td style="padding-left:  1.2rem!important;width:68%;">Discount
                            ({{ $order->order_detail->discount_name }})
                        </td>
                        <td><strong style="display: inline-flex;">IDR <span
                                        style="color: rgb(4,155,248);float: right;padding-right: 5%">-{{ number_format($order->product_discount,0) }}</span></strong>
                        </td>
                    </tr>
                @endif
                ...
                @if($order->voucher_amount > 0)
                    <tr>
                        <td style="padding-left:  1.2rem!important;width:68%;">Voucher Discount
                            ({{ $order->voucher_code }})
                        </td>
                        <td><strong style="display: inline-flex;">IDR <span
                                        style="color: rgb(4,155,248);float: right;padding-right: 5%">-{{ number_format($order->voucher_amount,0) }}</span></strong>
                        </td>
                    </tr>
                @endif
                ...
                <tr>
                    ...
                    <td><strong style="display: inline-flex;">IDR <span
                                    style="float: right;padding-right: 5%">{{ number_format($order->total_amount,0) }}</span></strong>
                    </td>
                </tr>
            </table>
        </td>
    ...
    <tr>
        <td colspan="3">
            <table style="width: 100%;">
                ...
                @if($order->order_detail->discount_amount > 0)
                    <tr>
                        <td style="padding-left:  1.2rem!important;width:68%;">Diskon
                            ({{ $order->order_detail->discount_name }})
                        </td>
                        <td><strong style="display: inline-flex;">IDR <span
                                        style="color: rgb(4,155,248);float: right;padding-right: 5%">-{{ number_format($order->product_discount,0) }}</span></strong>
                ...
                @if($order->voucher_amount > 0)
                    <tr>
                        <td style="padding-left:  1.2rem!important;width:68%;">Diskon Voucher
                            ({{ $order->voucher_code }})
                        </td>
                        <td><strong style="display: inline-flex;">IDR <span
                                        style="color: rgb(4,155,248);float: right;padding-right: 5%">-{{ number_format($order->voucher_amount,0) }}</span></strong>
