		...
		<td colspan="3">
			<table style="padding: 5px 0;width: 100%;">
				...
				@if($order->order_detail->fee_amount > 0)
					<tr>
						<td style="padding-left:1.2rem!important;width: 75%;">Charge {{ $order->order_detail->fee_name }}</td>
				...
				@endif
					...
					@if($order->fee_credit_card >0)
						<tr>
							<td style="padding-left:1.2rem!important;width: 75%;">Credit Card Charge</td>
					...
					@if($order->fee > 0)
						<tr>
							<td style="padding-left:1.2rem!important;width: 75%;">Charge {{ $order->payment->payment_gateway }}</td>
				...
				@if($order->order_detail->discount_amount > 0)
					<tr>
						<td style="padding-left:1.2rem!important;width: 75%;">Discount</td>
				...
				@if($order->voucher_amount > 0)
					<tr>
						<td style="padding-left:1.2rem!important;width: 75%;">Voucher Discount</td>
				...
				<tr>
					<td style="padding-left:1.2rem!important;width: 75%;">Total</td>
	...
	<tr>
		<td colspan="3">
			<table style="padding: 5px 0;width: 100%;">
				...
				@if($order->order_detail->fee_amount > 0)
					<tr>
						<td style="padding-left:1.2rem!important;width: 75%;">Biaya {{ $order->order_detail->fee_name }}</td>
						<td><strong style="display:inline-flex;">IDR <span style="float: right;padding-right: 8%;">{{ number_format($order->order_detail->fee_amount,0) }}</span></strong></td>
					</tr>
				@endif
					...
					@if($order->fee_credit_card >0)
						<tr>
							<td style="padding-left:1.2rem!important;width: 75%;">Biaya Kartu Kredit</td>
							<td><strong style="display:inline-flex;">IDR <span style="float: right;padding-right: 8%;">{{ number_format($order->fee_credit_card,0) }}</span></strong></td>
						</tr>
					@endif
					...
					@if($order->fee >0)
						<tr>
							<td style="padding-left:1.2rem!important;width: 75%;">Biaya {{ $order->payment->payment_gateway }}</td>
							<td><strong style="display:inline-flex;">IDR <span style="float: right;padding-right: 8%;">{{ number_format($order->fee_credit_card,0) }}</span></strong></td>
						</tr>
					@endif
				...
				@if($order->order_detail->discount_amount > 0)
					<tr>
						<td style="padding-left:1.2rem!important;width: 75%;">Diskon</td>
						<td><strong style="display:inline-flex;">IDR <span style="float: right;padding-right: 8%;color: rgb(4,155,248)">-{{ number_format($order->product_discount,0) }}</span></strong></td>
					</tr>
				@endif
				...
				@if($order->voucher_amount > 0)
					<tr>
						<td style="padding-left:1.2rem!important;width: 75%;">Diskon Voucher</td>
						<td><strong style="display:inline-flex;">IDR <span style="float: right;padding-right: 8%;color: rgb(4,155,248)">-{{ number_format($order->voucher_amount,0) }}</span></strong></td>
					</tr>
				@endif
