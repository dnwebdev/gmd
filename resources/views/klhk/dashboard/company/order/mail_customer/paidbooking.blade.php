           ...
           <td colspan="3">
                <table style="width: 100%;">
                    ...
                    @if($order->order_detail->fee_amount > 0)
                        <tr>
                            <td></td>
                            <td style="padding-left:  1.2rem!important;width:68%;">Charge {{ $order->order_detail->fee_name }}</td>
                            <td><strong>IDR <span style="float: right;padding-right: 5%">{{ number_format($order->order_detail->fee_amount,0) }}</span></strong></td>
                        </tr>
                    @endif
                        ...
                        @if($order->fee_credit_card >0)
                            <tr>
                                <td></td>
                                <td style="padding-left:  1.2rem!important;width:68%;">Credit Card Charge</td>
                                <td><strong>IDR <span style="float: right;padding-right: 5%">{{ number_format($order->fee_credit_card,0) }}</span></strong></td>
                            </tr>
                        @endif
                        {{-- Fee --}}
                        @if ($order->fee > 0)
                            <tr>
                                <td></td>
                                <td style="padding-left:  1.2rem!important;width:68%;">Charge {{ $order->payment->payment_gateway }}</td>
                                <td><strong>IDR <span style="float: right;padding-right: 5%">{{ number_format($order->fee,0) }}</span></strong></td>
                            </tr>
                        @endif
                    ...
                    @if($order->order_detail->discount_amount > 0)
                        <tr>
                            <td></td>
                            <td style="padding-left:  1.2rem!important;width:68%;">Discount ({{ $order->order_detail->discount_name }})</td>
                            <td ><strong>IDR <span style="color: rgb(4,155,248);float: right;padding-right: 5%">-{{ number_format($order->product_discount,0) }}</span></strong></td>
                        </tr>
                    @endif
                    ...
                    @if($order->voucher_amount > 0)
                        <tr>
                            <td></td>
                            <td style="padding-left:  1.2rem!important;width:68%;">Voucher Discount ({{ $order->voucher_code }})</td>
                            <td ><strong>IDR <span style="color: rgb(4,155,248);float: right;padding-right: 5%">-{{ number_format($order->voucher_amount,0) }}</span></strong></td>
                        </tr>
                    @endif

                    <tr>
                        <td></td>
                        <td style="padding-left:  1.2rem!important;width:68%;">Total</td>
                        <td ><strong>IDR <span style="float: right;padding-right: 5%">{{ number_format($order->total_amount,0) }}</span></strong></td>
                    </tr>
                </table>
           </td>
        </tr>
           ...
           <td colspan="3">
                <table width="100%">
                    ...
                    @if($order->order_detail->fee_amount > 0)
                        <tr>
                            <td></td>
                            <td style="padding-left:  1.2rem!important;width:68%;">Biaya {{ $order->order_detail->fee_name }}</td>
                            <td><strong>IDR <span style="float: right;padding-right: 5%">{{ number_format($order->order_detail->fee_amount,0) }}</span></strong></td>
                        </tr>
                    @endif
                        ...
                        @if($order->fee_credit_card > 0)
                            <tr>
                                <td></td>
                                <td style="padding-left:  1.2rem!important;width:68%;">Biaya Kartu Kredit</td>
                                <td><strong>IDR <span style="float: right;padding-right: 5%">{{ number_format($order->fee_credit_card,0) }}</span></strong></td>
                            </tr>
                        @endif
                        ...
                        @if($order->fee > 0)
                            <tr>
                                <td></td>
                                <td style="padding-left:  1.2rem!important;width:68%;">Biaya {{ $order->payment->payment_gateway }}</td>
                                <td><strong>IDR <span style="float: right;padding-right: 5%">{{ number_format($order->fee,0) }}</span></strong></td>
                            </tr>
                        @endif
                    ...
                    @if($order->order_detail->discount_amount > 0)
                        <tr>
                            <td></td>
                            <td style="padding-left:  1.2rem!important;width:68%;">Diskon ({{ $order->order_detail->discount_name }})</td>
                            <td ><strong>IDR <span style="color: rgb(4,155,248);float: right;padding-right: 5%">-{{ number_format($order->product_discount,0) }}</span></strong></td>
                        </tr>
                    @endif
                    ...
                    @if($order->voucher_amount > 0)
                        <tr>
                            <td></td>
                            <td style="padding-left:  1.2rem!important;width:68%;">Voucher Diskon ({{ $order->voucher_code }})</td>
                            <td ><strong>IDR <span style="color: rgb(4,155,248);float: right;padding-right: 5%">-{{ number_format($order->voucher_amount,0) }}</span></strong></td>
                        </tr>
                    @endif
