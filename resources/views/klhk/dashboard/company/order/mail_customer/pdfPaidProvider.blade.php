			...
			<table style="width: 100%;">
				...
				@if($order->order_detail->fee_amount > 0)
					<tr>
						...
						<td><strong style="display: inline-flex;">IDR <span style="float: right;">{{ number_format($order->order_detail->fee_amount,0) }}</span></strong></td>
					</tr>
				@endif
					...
					@if ($order->fee > 0)
						<tr>
							<td style="padding-left:1.2rem!important;width: 67%;">Charge {{ $order->payment->payment_gateway }}</td>
							<td><strong style="display: inline-flex;">IDR <span style="float: right;">{{ number_format($order->fee,0) }}</span></strong></td>
						</tr>
					@endif
				...
				@if($order->voucher_amount > 0)
					<tr>
						<td style="padding-left:1.2rem!important;width: 67%;">Voucher Discount ({{ $order->voucher_code }})</td>
		...
		<td colspan="3">
			<table style="width: 100%;">
				...
				@endif
					...
					@if($order->fee_credit_card > 0)
						<tr>
							<td style="padding-left:1.2rem!important;width: 67%;">Biaya Kartu Kredit</td>
							<td><strong style="display: inline-flex;">IDR <span style="float: right;">{{ number_format($order->fee_credit_card,0) }}</span></strong></td>
						</tr>
					@endif

					@if($order->fee > 0)
						<tr>
							<td style="padding-left:1.2rem!important;width: 67%;">Biaya {{ $order->payment->payment_gateway }}</td>
							<td><strong style="display: inline-flex;">IDR <span style="float: right;">{{ number_format($order->fee,0) }}</span></strong></td>
						</tr>
					@endif
				...
				@if($order->voucher_amount > 0)
					<tr>
						<td style="padding-left:1.2rem!important;width: 67%;">Diskon Voucher ({{ $order->voucher_code }})</td>
						<td><strong style="display: inline-flex;">IDR <span style="float: right;color: rgb(4,155,248)">-{{ number_format($order->voucher_amount,0) }}</span></strong></td>
					</tr>
				@endif
