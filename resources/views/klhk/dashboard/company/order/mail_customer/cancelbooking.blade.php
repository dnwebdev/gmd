                ...
                <table class=" padding" style="width: 100%;padding: 5px 0;">
                    ...
                    @if($order->order_detail->discount_amount > 0)
                        <tr>
                            ...
                            <td><strong>IDR <span style="float: right;padding-right: 5%;color: rgb(4,155,248);">-{{ number_format($order->product_discount,0) }}</span></strong></td>
                        </tr>
                    @endif
                    ...
                    @if($order->voucher_amount > 0)
                        <tr>
                            ...
                            <td ><strong>IDR <span style="float: right;padding-right: 5%;color: rgb(4,155,248);">-{{ number_format($order->voucher_amount,0) }}</span></strong></td>
                        </tr>
                    @endif
...
<table cellpadding="5" cellspacing="0" style="border-collapse:collapse;width: 680px; margin: auto;">
    <tbody>
        ...
        <tr>
           <td colspan="3">
                <table style="padding-right: 5%;width: 100%;">
        ...
        @if($order->guides->count() > 0)
            ...
            <tr>
                <td colspan="3">
                    <table style="float: right;padding-right: 5%; width: 100%;">
                        <thead>
                            <tr align="left">
                                <th style="padding: 15px;width: 20%;">No</th>
                                <th style="padding: 15px;width: 25%">Nama Pemandu</th>
                                <th style="padding: 15px;width: 15%;">Nomor Telepon</th>
                            </tr>
                        </thead>
                        <tbody>
                        @foreach($order->guides as $guide)
