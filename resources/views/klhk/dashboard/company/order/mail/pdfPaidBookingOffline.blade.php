        ...
        <td colspan="3">
            <table style="float: right;width: 100%;">
                ...
                @if($order->order_detail->fee_amount > 0)
                    <tr>
                        <td style="padding-left: 1.2rem!important;width: 69%;">
                            Charge {{ $order->order_detail->fee_name }}</td>
                        <td><strong style="display: inline-flex;">IDR <span
                                        style="float: right;">{{ number_format($order->order_detail->fee_amount,0) }}</span></strong>
                        </td>
                    </tr>
                @endif
                    ...
                    @if($order->fee_credit_card >0)
                        <tr>
                            ...
                            <td><strong style="display: inline-flex;">IDR <span
                                            style="float: right;">{{ number_format($order->fee_credit_card,0) }}</span></strong>
                            </td>
                        </tr>
                    @endif
                    ...
                    @if($order->fee >0)
                        <tr>
                            ...
                            <td><strong style="display: inline-flex;">IDR <span
                                            style="float: right;">{{ number_format($order->fee,0) }}</span></strong>
                            </td>
                        </tr>
                    @endif
                ...
                @if($order->order_detail->discount_amount > 0)
                    <tr>
                        ...
                        <td><strong style="display: inline-flex;">IDR <span style="float: right;color: rgb(4,155,248);">-{{ number_format($order->product_discount,0) }}</span></strong>
                        </td>
                    </tr>
                @endif
                ...
                @if($order->voucher_amount > 0)
                    <tr>
                        ...
                        <td><strong style="display: inline-flex;">IDR <span style="float: right;color: rgb(4,155,248);">-{{ number_format($order->voucher_amount,0) }}</span></strong>
                        </td>
                    </tr>
                @endif

                <tr style="padding-bottom: 4rem;">
                    <td style="padding-left: 1.2rem!important;width: 69%;">Total</td>
                    <td><strong style="display: inline-flex;">IDR <span
                                    style="float: right;padding-right: 10px;">{{ number_format($order->total_amount,0) }}</span></strong>
                    </td>
                </tr>
            </table>
        </td>
