...
@section('additionalStyle')
    ...
    <link href="{{ asset('klhk-asset/dest-operator/css/product_create_klhk.css') }}" rel="stylesheet">
...
<div class="content pt-0" dashboard> 
    ...
    <div data-template="widget">
            ...
            <div class="product">
                <div class="step3">
                    <form id="form_ajax" method="POST" action="{{ Route('company.product.store') }}" novalidate
                          autocomplete="off">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-12 col-lg-6 col-xl-5">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label class="error d-none"
                                                       id="category-long">{{ trans('product_provider.max_category_3') }}</label>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="state" id="state_search" class="select2-product form-control"
                                                    ...
                                                    @foreach (App\Models\State::where('id_country', 102)->orderBy('state_name', 'asc')->get() as $item)
                                                        <option value="{{ $item->id_state }}">{{ $item->state_name }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="city" id="city_search" class="select2-product form-control"
                                                        ...
                                                        required>
                                                    <option selected
                                                            disabled>{{ trans('product_provider.select_city') }}</option>
                                                </select>
                                            ...
                                            <div class="form-group">
                                                <label for="about" class="tooltips"
                                                    ...
                                                    <span class="text-danger">*</span><span
                                                            class="fa fa-info-circle fs-14"></span></label>
                                                <textarea id="long_description" class="form-control itinerary-input"
                                                          rows="7"
                            ...
                            <div class="widget-content">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                        <div class="form-group select-icon-dropdown">
                                            <label for="availability">{{ trans('product_provider.select_time') }} <span
                                    ...
                                    <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 mb-20" id="day_fix">
                                        <div class="form-group">
                                            <label for="availability">{{ trans('product_provider.select_day') }} <span
                                                        class="text-danger">*</span></label>
                                            <div class="row days-group">
                                                <div class="col">

                                                    <div class="custom-control custom-checkbox custom-control-inline form-check">
                                                        <input type="checkbox" class="custom-control-input all day"
                                                               id="all.0" name="all[0]" onclick="toggle(this)"
                                                               value="1">
                                                        <label class="custom-control-label label-all-day"
                                                               for="all.0">{{ trans('product_provider.allday') }}</label>
                                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="input-field start_label">
                                                    <label for="start_date"
                                                           id="tgl">{{ trans('product_provider.start_date') }} <span
                                                                class="text-danger">*</span></label>
                        ...
                        <!-- Product Pricing -->
                        <div class="widget card product-pricing" id="product-pricing"
                             data-valdiation="{{ trans('product_provider.product_pricing_validation') }}">
                            <div class="widget-header">
                            ...
                            <div class="widget-content">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label for="price_type"
                                                   class="tooltips tooltipstered active d-block">{{ trans('product_provider.price_type') }}</label>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input mt-0 mb-1" name="price_type" type="radio"
                                                       value="" id="fixed_price">
                                                <label class="form-check-label tooltips" for="fixed_price"
                                                       title="{{ trans('product_provider.fixed_price_tooltip') }}">
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input mt-0 mb-1" name="price_type" type="radio"
                                                       value="" id="price_tier">
                                                <label class="form-check-label tooltips" for="price_tier"
                                                       title="{{ trans('product_provider.group_price_tooltip') }}">
                                    ...
                                    <div class="col-lg-4 price-type-d-none">
                                        <div class="form-group">
                                            <label for="from" class="mb-1"
                                                   title="{{ trans('product_provider.pax_from_tooltip') }}">{{ trans('product_provider.pax_from') }}
                                                <label class="dynamic_pricing"></label>
                                                {{-- <span class="fa fa-info-circle fs-14"></span> --}}
                                            </label>
                                            <span class="text-danger">*</span>
                                            <div class="price_from_label">{{ trans('product_provider.pax_from_label') }}</div>
                                            <div class="warning_label d-none"><i class="fa fa-exclamation-triangle"></i>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            <label for="price.0">
                                                <span class="price-label"
                                                      data-price-fix="{{ trans('product_provider.price') }}"
                                                      data-price-group="{{ trans('product_provider.price_group') }}"></span>
                                                <label class="dynamic_pricing"></label>
                                                <span class="text-danger">*</span>
                                            </label>
                                            <div class="warning_label d-none"><i class="fa fa-exclamation-triangle"></i>
                                ...
                                <div class="row">
                                    <div class="col-lg-11">
                                        <button type="button"
                                                class="btn btn-success btn-sm btn-add add_price mt-4 float-right"><i
                                                    class="fa fa-plus"></i>{{ trans('product_provider.add_price') }}
                                        </button>
                                    </div>
                                </div>
                                {{--                                <hr class="full-hr">--}}
                                ...
                                <div class="row custom-input-clone" data-custom-index="0">
                                    <div class="col-sm-12 mb-3">
                                        <div class="row">
                                            ...
                                            <div class="col-sm-2">
                                                <button type="button"
                                                        class="btn btn-success btn-sm btn-add add_custom_input mt-40 d-block small">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 text-muted">
                                                @foreach (collect(trans('product_provider.custom_descriptions'))->except(['document', 'photo']) as $key => $doc)
                                                    <span class="custom-desc custom-desc-{{ $key }}"
                                                          style="display: {{ $loop->index == 0 ? 'block' : 'none' }}">{{ $doc }}</span>
                                                @endforeach
                                    ...
                                    <div class="col-sm-12 col-md-6 mt-1">
                                        ...
                                        <div class="form-group mt-3 ml-1">
                                            <div class="custom-control custom-checkbox">
                                                <input type="checkbox" class="custom-control-input" id="show_exclusion" name="show_exclusion" checked value="1">
                                        ...
                                        <div class="custom-image-gallery">
                                            <div class="widget-image input-field col-sm-12 col-md-12 col-lg-6 col-xl-3 text-center border-product">
                                                <label class="custom-input-cropping-image">
                                                    <input type="file" id="input-file-now" name="images[0]"
                                                           class="cropping-image custom-file-input"
                                                           data-allowed-file-extensions="jpg jpeg png"  
                                                           accept="image/*"
                                                           data-default-file="" data-max-file-size="2M"
                                                           data-id="0" aria-describedby="image-name-0"
                                                           data-type="images" data-array="true"/>
                                            ...
                                            <div class="widget-image input-field col-sm-12 col-md-12 col-lg-6 col-xl-3 text-center border-product">
                                                <label class="custom-input-cropping-image">
                                                    <input type="file" id="input-file-now" name="images[1]"
                                                           class="cropping-image custom-file-input"
                                                           data-allowed-file-extensions="jpg jpeg png"  
                                                           accept="image/*"
                                                           data-default-file="" data-max-file-size="2M"
                                                           data-id="1" aria-describedby="image-name-1"
                                                           data-type="images" data-array="true"/>
                                                    <i class="fa fa-cloud-upload"></i>
                                                    <span>{{ trans('premium.facebook.label.upload') }}</span>
                                                </label>
                                            ...
                                            <div class="widget-image input-field col-sm-12 col-md-12 col-lg-6 col-xl-3 text-center border-product">
                                                <label class="custom-input-cropping-image">
                                                    <input type="file" id="input-file-now" name="images[2]"
                                                           class="cropping-image custom-file-input"
                                                           data-allowed-file-extensions="jpg jpeg png"  
                                                           accept="image/*"
                                                           data-default-file="" data-max-file-size="2M"
                                                           data-id="2" aria-describedby="image-name-2"
                                                           data-type="images" data-array="true"/>
                                                    <i class="fa fa-cloud-upload"></i>
                                                    <span>{{ trans('premium.facebook.label.upload') }}</span>
                                                </label>
                                                ...
                                                <div class="text-center">
                                                    <div class="input-group mb-3 display-none group-input-image-2 input-group-cropping-image">
                                                        <input type="text"
                                                               class="form-control label-data-name-file-2 overflow-hidden"
                                                               readonly>
                                                        <div class="input-group-append">
                                                            <button type="button"
                                                                    class="btn btn-danger btn-remove-image-cropper remove-crop-image-2"
                                                                    data-id="2">
                                                                {{ trans('product_provider.remove_image') }}
                                                            </button>
                                                        </div>
                                            ...
                                            <div class="widget-image input-field col-sm-12 col-md-12 col-lg-6 col-xl-3 text-center border-product">
                                                <label class="custom-input-cropping-image">
                                                    <input type="file" id="input-file-now" name="images[3]"
                                                           class="cropping-image custom-file-input"
                                                           data-allowed-file-extensions="jpg jpeg png"  
                                                           accept="image/*"
                                                           data-default-file="" data-max-file-size="2M"
                                                           data-id="3" aria-describedby="image-name-3"
                                                           data-type="images" data-array="true"/>
                                                    <i class="fa fa-cloud-upload"></i>
                                                    <span>{{ trans('premium.facebook.label.upload') }}</span>
                                                </label>
                                                ...
                                                <div class="text-center">
                                                    <div class="input-group mb-3 display-none group-input-image-3 input-group-cropping-image">
                                                        <input type="text"
                                                               class="form-control label-data-name-file-3 overflow-hidden"
                                                               readonly>
                                                        <div class="input-group-append">
                                                            <button type="button"
                                                                    class="btn btn-danger btn-remove-image-cropper remove-crop-image-3"
                                                                    data-id="3">
                                                                {{ trans('product_provider.remove_image') }}
                                                            </button>
                                                        </div>
                        ...
                        <!-- Itinerary -->
                            ...
                            <div class="row">
                                <div class="dashboard-cta col text-right">
                                    <button id="btn-submit" class="btn bg-green-klhk btn-cta step4"
                                            type="button" name="action"
                                            data-submit="{{trans('product_provider.submit')}}"
                            ...
                            @if (\App\Models\Ota::where('ota_status', true)->exists())
                                <button id="btn-show-ota" type="button" data-toggle="modal" data-target="#ota-modal"
                                        class="d-none"
                                        data-url="{{ route('company.product.update_ota') }}">modal ota
                                </button>
                        @include('klhk.dashboard.company.product.ota_modal')
                        @endif
                    </form>
                </div>
            </div>
...
{{--    <script async defer--}}
    ...
    <script type="text/javascript"
            src="{{ asset('klhk-asset/dest-operator/lib/js/jquery.tablesorter.min.js') }}"></script>
        ...
        $(document).ready(function () {
            ...
            $('input[name="start_date[0]"]')
                ...
                .on('changeDate', function (e) {
                    var endDate = $('input[name="end_date[0]"]')
            ...
            //             // $('#state_search').select2('destroy');
            //             $('#city_search').append(new Option('Select City / Kota',''))
            //             // $('#state_search').append(new Option('Select State / Provinsi',''))
            //             @if(app()->getLocale() =='id')
            //             $.each(data, function (index, item) {
            //                 $('#state_search').append(new Option(item.state_name, item.id_state))
            //             })
            //             @else
            //             $.each(data, function (index, item) {
            //                 $('#state_search').append(new Option(item.state_name_en, item.id_state))
            //             })
            //             @endif
            //             //   $('#state_search').append(html);
