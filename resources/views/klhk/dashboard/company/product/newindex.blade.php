...
<div class="content pt-0" dashboard>
    ...
    <div class="modal" id="modal-delete-product" tabindex="-1" role="dialog" aria-labelledby="DeleteProductModal" aria-hidden="true">
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            ...
            <button type="button" id="copy-code" class="btn bg-green-klhk"><i class="fa fa-copy"></i>{{ trans('product_provider.copy') }}</button>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="tooltip_templates d-none">
      <span id="tooltipWidgetContent" class="d-block text-center">
        {{ trans('product_provider.widget_button_tooltip') }} <a href="{{ url('/widget-faq') }}" class="text-green" target="_blank">{{ trans('product_provider.widget_button_tooltip_link') }}</a>
      </span>
