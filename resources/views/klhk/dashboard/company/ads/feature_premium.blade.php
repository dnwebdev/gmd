<div class="widget available-adds stepPremium1" id="fb-ig">
    <div class="row">
        ...
        <div class="col-12 col-lg-3 text-center justify-content-center">
            <button class="btn bg-green-klhk btn-buy-now" href="facebook-ads.html" id="button-buy-now" type="button" style="margin-bottom:1rem;" data-ads="Facebook Ads">{{ trans('premium.banner.buy_now') }}</button>
...
<div class="widget available-adds" id="google">
    <div class="row">
        ...
        <div class="col-12 col-lg-3 text-center justify-content-center">
            ...
            <button class="btn bg-green-klhk btn-buy-now" id="btn-buy-now" type="button" style="background-color: #7F7F7F; border-color: #7F7F7F; margin-bottom:1rem;" disabled>{{ trans('premium.banner.coming_soon') }}</button>
            @else
            <button class="btn bg-green-klhk btn-buy-now" type="button" style="margin-bottom:1rem;" data-ads="Google Ads">{{ trans('premium.banner.buy_now') }}</button>
            @endif
        ...
        <form class="form-ads form-wizard form-google col" data-ads-type="google">
            ...
            <section class="text-center">
                <div class="container">
                    ...
                    <div class="form-group">
                        <input type="url" class="form-control gpreview" name="url" value="http://" required data-gpreview="url" placeholder="{{ __('premium.google.form.url.placeholder') }}" value="http://" />
                    </div>
