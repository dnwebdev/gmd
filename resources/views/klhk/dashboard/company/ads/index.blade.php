...
@section('additionalStyle')
    <link rel="stylesheet" href="{{ asset('klhk-asset/dest-operator/css/index_klhk.css') }}">
...
<div class="content pt-0" dashboard> 
    ...
    <div data-template="widget">
        ...
        <div id="buy-premium">
            @include('klhk.dashboard.company.ads.buy_premium')
        </div>
        <div id="riview-buy-ads" style="display : none;">
            <form id="review-fb">
                @include('klhk.dashboard.company.ads.review_premium')
            </form>
        </div>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('change', 'select[name=payment_method]', function(){
                ...
                if(select.val() === 'credit_card'){
                    ...
                    tablePayment.find('#creaditcard_change').remove();
                    ...
                    $.ajax({
                        ...
                        success: function(data){
                            let html = '<tr id="creaditcard_change">'+
                    ...
                    $(document).find('#creaditcard_change').remove()
            ...
            $(document).on('change', '#use-gxp, #use-gxp2', function(){
                ...
                if($(this).is(':checked')){
                    ...
                    $.ajax({
                        ...
                        success: function(data){
                            ...
                            if(data.gxp_amount >= data.grandTotal){
                                ...
                                tableGxp.find('#creaditcard_change').hide();
                    ...
                    switchStatus = $(this).is(':checked')
                    tableGxp.find('#creaditcard_change').show()
        ...
        $(document).on('keyup paste change input', '#min-price, .google-min-budget',function(){
            ...
            if(totalPrice < 10000){
                ...
                $(document).find('#small-min-price').html('Min anggaran Rp. 10.000')
            }else{
                $(document).find('#small-min-price').hide()
                let a = totalPrice % 10000;
                let b = totalPrice - a;
                totalPriceDay = b / 10000;
            }
            return true;
        })
