                                    ...
                                    <div id="collapseOne" class="collapse show"
                                        ...
                                        <div class="card-body bank-list">
                                            <div class="col-12 text-center virtual-account can-copy">
                                                <h3>{!! trans('customer.indomaret.code') !!} #
                                                    <span class="data-copied">{{ $order->payment->response['payment_code']}}</span>
                                                </h3>
                                                <h3>Merchant Name
                                            ...
                                            <div class="col-12 mb-3 text-center">
                                                <img class="img-fluid" width="120"
                                                     src="{{asset('img/midtrans/indomaret.png')}}" alt=""><br>
                                                <span class="bold data-copied">{!! trans('customer.indomaret.step-0') !!}</span>
                                            </div>
                                            <div class="col-12">
                                                <ol>
                                                    <li>
                                                        {!! trans('customer.indomaret.step-1') !!}
                                                    </li>
                                                    <li>
                                                        {!! trans('customer.indomaret.step-2') !!}
                                                    </li>
                                                    <li>
                                                        {!! trans('customer.indomaret.step-3') !!}
                                                    </li>
                                                    <li>
                                                        {!! trans('customer.indomaret.step-4') !!}
                                                    </li>
                                                    <li>
                                                        {!! trans('customer.indomaret.step-5') !!}
                                                    </li>
                                                </ol>
                                            </div>
                                        </div>
