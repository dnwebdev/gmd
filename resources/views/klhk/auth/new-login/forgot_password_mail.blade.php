...
{{--                <span class="d-block text-muted">We'll send you instructions in email</span>--}}
            ...
            <div class="form-group">
                <button class="btn bg-success btn-block next" type="button" id="submitButton" onclick="sendMail()" data-validation="{{trans('landing.link_mail_sent')}}"><i class="icon-spinner11 mr-2"></i> {{trans('landing.register.send_mail')}}
                </button>
            </div>
