...
{{--                    <i class="icon-spinner11 icon-2x text-success border-success border-3 rounded-round p-3 mb-3 mt-1"></i>--}}
                ...
                <div class="text-center mb-4 form-resend-otp">
                    <button type="button" class="btn-resend-otp" onclick="ResendOtp()"
                            data-validation="{{trans('landing.register.otp_resend')}}"
                            disabled>{{ trans('landing.register.resend_otp') }}</button>
                    <br>
                    <span id="timer"></span>
                </div>
                <input type="hidden" name="phone" data-validation="{{trans('landing.register.otp_resend')}}" value="{{ $phone }}">
                ...
                <span for="password" class="form-text text-danger error" id="password-length"
                ...
                <span for="repassword" class="form-text text-danger error" id="repassword-match"
                      data-validation="{{ trans('landing.register.password_not_match') }}"></span>

                <button class="btn bg-success btn-block mt-4 next" type="button" onclick="submitData()"
                        data-validation="{{trans('landing.register.activation_reset_password')}}" disabled><i
                            class="icon-spinner11 mr-2"></i> {{trans('landing.register.create_new_password')}}
                </button>
            </div>
        </div>
    {!! Form::close() !!}
...
@section('script')
    ...
    <script>
        ...
        var inputPhone = $('input[name="phone"]'),
                dataSent = inputPhone.attr('data-validation'),
