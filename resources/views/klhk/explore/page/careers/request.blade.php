                                        ...
                                        <div class="row">
                                            <div class="col-lg-8 mb-30 mt-15">
                                                <div class="form-group">
                                                    <label for="full_name">{{trans('explore-lang.career.name')}}<span class="required-color-red">*</span></label>
                                                ...
                                                <div class="form-group">
                                                    <label for="phone_number">{{trans('explore-lang.career.phone')}}<span class="required-color-red">*</span></label>
                                                    {!! Form::tel('phone_number',null,['class'=>'form-control number']) !!}
                                                </div>
                                                <div class="form-group">
                                                    <label for="portfolio">Portfolio & CV <span class="required-color-red">*</span></label>
