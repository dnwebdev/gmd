<div class="modal fade modal-download" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form method="post" action="{{ route('admin:master.transaction.export') }}">
      {{ csrf_field() }}
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="d-block">
            <span class="d-inline-flex">
              ...
              <input type="checkbox" class="switch switch-bootstrap status" name="status" id="status" value="1">
        ...
        <div class="modal-footer">
          ...
          <button type="submit" class="btn bg-green-klhk">Download</button>
        </div>
      </div>
    </form>
