...
<link href="{{ asset('css/profile-inline-fix.css') }}" rel="stylesheet">
{{-- <link rel="stylesheet" href="{{ asset('select2/select2.min.css') }}"> --}}
<link href="{{ url('css/component-custom-switch.min.css') }}" rel="stylesheet">
<style type="text/css">
    .dashboard-content .widget .widget-content .switch-rounded {
        position: relative;
    ...
    .dashboard-content .widget .widget-content .switch-rounded input {
        opacity: 0;
        width: 0;
        height: 0
    }
        ...
        <div class="step1">
            <form id="form_ajax_setting" method="POST" action="{{ Route('company.profile.update') }}">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="widget card" id="operator-logo">
                            <div class="widget-header widget-collapse" id="header-operator-logo" data-toggle="collapse"
                                data-target="#content-operator-logo">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-6 col-12">
                                        <div class="form-group">
                                            <div class="custom-radio-control custom-radio">
                                                <input type="radio" id="custom-logo" name="operator-logo" value="custom"
                                                ...
                                                <div class="custom-block is-open">
                                                    <div
                                                        class="custom-logo-block d-lg-flex align-items-end justify-content-center">
                                                        <div class="custom-logo-image position-relative text-center">
                                                            ...
                                                            <label class="custom-input-cropping-image">
                                                                ...
                                                                custom-file-input"
                                                                    ...
                                                                    data-disable-remove="true" data-id="0"
                                                                    data-ratio="1" data-array="false"
                                                                    data-type="logo" />
                                                            ...
                                                            <div class="text-center">
                                                                <div
                                                                    class="input-group mb-3 display-none group-input-image-0 input-group-cropping-image">
                                                                    <input type="text"
                                                            ...
                                                            <div class="text-center">
                                                                <div
                                                                    class="input-group mb-3 {{ empty($company->logo) ? 'display-none' : '' }} group-input-image-0 input-group-cropping-image">
                                                                    <input type="text"
                                                                        class="form-control label-data-name-file-0 overflow-hidden"
                                        ...
                                        <div class="form-group">
                                            <div class="custom-radio-control custom-radio">
                                                <input type="radio" id="default-logo" name="operator-logo"
                                                    value="default" class="custom-control-input"
                                                    {{in_array($company->logo,['dest-operator/img/logo1.png','dest-operator/img/logo2.png','dest-operator/img/logo3.png','dest-operator/img/logo4.png','dest-operator/img/logo5.png'])?'checked':null}}>
                                                <label class="custom-control-label"
                                                    ...
                                                    <div class="custom-default-logo">
                                                        <label for="dlogo-1">
                                                            <input type="radio" id="dlogo-1"
                                                                value="dest-operator/img/logo1.png" name="default-logo"
                                                                {{$company->logo=='dest-operator/img/logo1.png'?'checked':null}}>
                                                            <img src="{{ asset('dest-operator/img/logo1.png') }}"
                                                                alt="CAMPING">
                                                        </label>
                                                        <label for="dlogo-2">
                                                            <input type="radio" id="dlogo-2"
                                                                value="dest-operator/img/logo2.png" name="default-logo"
                                                                {{$company->logo=='dest-operator/img/logo2.png'?'checked':null}}>
                                                            <img src="{{ asset('dest-operator/img/logo2.png') }}"
                                                                alt="DIVER">
                                                        </label>
                                                        <label for="dlogo-3">
                                                            <input type="radio" id="dlogo-3"
                                                                value="dest-operator/img/logo3.png" name="default-logo"
                                                                {{$company->logo=='dest-operator/img/logo3.png'?'checked':null}}>
                                                            <img src="{{ asset('dest-operator/img/logo3.png') }}"
                                                                alt="SURFING">
                                                        </label>
                                                        <label for="dlogo-4">
                                                            <input type="radio" id="dlogo-4"
                                                                value="dest-operator/img/logo4.png" name="default-logo"
                                                                {{$company->logo=='dest-operator/img/logo4.png'?'checked':null}}>
                                                            <img src="{{ asset('dest-operator/img/logo4.png') }}"
                                                                alt="WATERSPORT">
                                                        </label>
                                                        <label for="dlogo-5">
                                                            <input type="radio" id="dlogo-5"
                                                                value="dest-operator/img/logo5.png" name="default-logo"
                                                                {{$company->logo=='dest-operator/img/logo5.png'?'checked':null}}>
                                                    ...
                                                    <div class="custom-banner-holder position-relative text-center">
                                                        ...
                                                        <label class="custom-input-cropping-image">
                                                            <input type="file" name="banner" name="banner"
                                                                ...
                                                                data-allowed-file-extensions="jpg jpeg png" data-id="1"
                                                                data-ratio="1.78" data-type="banner" data-array="false">
                                                            <i class="fa fa-cloud-upload"></i>
                                                            <span>{{ trans('premium.facebook.label.upload') }}</span>
                                                        </label>
                                                        ...
                                                        <div class="text-center">
                                                            <div
                                                                class="input-group mb-3 display-none group-input-image-1 input-group-cropping-image">
                                                                <input type="text"
                                                        ...
                                                        <div class="text-center">
                                                            <div
                                                                class="input-group mb-3 {{ empty($company->banner) ? 'display-none' : '' }} group-input-image-1 input-group-cropping-image">
                                                                <input type="text"
                                                                    class="form-control label-data-name-file-1 overflow-hidden"
                                                    ...
                                                    <div class="custom-default-banner">
                                                        <label for="dbanner-1">
                                                            <input type="radio" id="dbanner-1"
                                                                ...
                                                                {{$company->banner =='dest-operator/img/banner1.jpg'?'checked':null}}
                                                                name="default-banner">
                                                        ...
                                                        <label for="dbanner-2">
                                                            <input type="radio" id="dbanner-2"
                                                                ...
                                                                {{$company->banner =='dest-operator/img/banner2.jpg'?'checked':null}}
                                                                name="default-banner">
                                                        ...
                                                        <label for="dbanner-3">
                                                            <input type="radio" id="dbanner-3"
                                                                ...
                                                                {{$company->banner =='dest-operator/img/banner3.jpg'?'checked':null}}
                                                                name="default-banner">
                                                        ...
                                                        <label for="dbanner-4">
                                                            <input type="radio" id="dbanner-4"
                                                                ...
                                                                {{$company->banner =='dest-operator/img/banner4.jpg'?'checked':null}}
                                                                name="default-banner">
                            ...
                            <div class="widget-content collapse" id="content-operator-settings">
                                <div class="widget-form">
                                    <div class="form-group">
                                        ...
                                        <input type="text" placeholder="{{ trans('setting_provider.operator_name') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="domain_memoria" name="domain_memoria"
                                            class="form-control" value="{{ $company->domain_memoria }}" readonly>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <textarea name="short_description"
                                            ...
                                            id="short_description" rows="3" class="form-control"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="about" id="about"
                                            placeholder="{{ trans('setting_provider.this_will_be') }}" rows="6"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="pac-input"
                                            placeholder="{{ trans('setting_provider.office_location') }}">
                                        <div id="map"></div>
                                    ...
                                    <div class="form-group multiple">
                                        ...
                                        <div class="form-with-icon">
                                            ...
                                            <input type="email"
                                                ...
                                                class="form-control no-space" name="email_company" id="email_company"
                                    ...
                                    <div class="form-group multiple">
                                        ...
                                        <div class="form-with-icon">
                                            ...
                                            <input name="phone_company"
                                                placeholder="{{ trans('setting_provider.use_country') }}" type="text"
                                                class="form-control number" name="phone_company" id="phone_company"
                                                value="{{ $company->phone_company }}" maxlength="15">
                                        </div>
                                    </div>
                                    <div class="form-group multiple">
                                        ...
                                        <div class="form-with-icon">
                                            ...
                                            <input type="text"
                                                ...
                                                class="form-control" name="facebook_company" id="facebook_company"
                                                placeholder='facebook' value="{{ $company->facebook_company }}"
                                                maxlength="50">
                                        </div>
                                        <div class="form-with-icon">
                                            <span class="form-icon"><span class="fa fa-instagram"></span></span>
                                            <span class="form-icon" style="margin-left: 22px;"><span> | </span></span>
                        ...
                        <div class="widget card seo" id="seo">
                            <div class="widget-header widget-collapse" data-toggle="collapse" data-target="#content-seo"
                                id="seo-header">
                                <h3 class="tooltips" title="{{ trans('setting_provider.seo_tooltip') }}">SEO<span
                                ...
                                <div class="widget-form">
                                    <div class="form-group">
                                        <label for="title" class="tooltips"
                                            ...
                                            <span class="fa fa-info-circle"></span></label>
                                        <input name="title" type="text" value="{{ $company->title }}"
                                            class="form-control" placeholder="{{ trans('setting_provider.max_70') }}"
                                            maxlength="70">
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" id="description" cols="30" rows="4"
                                            class="form-control" placeholder="{{ trans('setting_provider.max_150') }}"
                            ...
                            <div class="widget-content collapse" id="content-bank">
                                <div class="widget-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="bank" class="form-control select2" placeholder="Select Bank">
                                            @foreach (\App\Models\CompanyBank::$banks as $key => $value)
                                            <option value="{{ $key }}"
                                                {{ $company->bank? $company->bank->bank == $key ? 'selected' : '':'' }}>
                                                {{ $value }}
                                            </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="bank_account_name" type="text" autocomplete="off"
                                            value="{{ $company->bank?$company->bank->bank_account_name:'' }}"
                                            class="form-control" maxlength="50">
                                    </div>
                                    <div class="form-group">
                                        <label
                                            for="bank_account_number">{{ trans('bank_provider.account_number') }}</label>
                                        <input name="bank_account_number" type="text" autocomplete="off"
                                    ...
                                    <div class="form-group bank-document-container text-center">
                                        <label
                                            for="bank_account_document">{{ trans('bank_provider.bank_document') }}</label><br>
                                        ...
                                        <label class="custom-input-cropping-image">
                                            <input type="file" name="bank_account_document"
                                                ...
                                                data-allowed-file-extensions="jpg jpeg png"
                                                {{-- @if($company->bank)
                                                       data-default-file="{{ asset('uploads/bank_document/'.$company->bank->bank_account_document) }}" @endif --}}
                                                data-array="false" data-id="2" data-type="bank_account_document"
                                                data-ratio="1.78" />
                                            <i class="fa fa-cloud-upload"></i>
                                            <span>{{ trans('premium.facebook.label.upload') }}</span>
                                        </label>
                                    ...
                                    {{--                                                        <label for="short_description" class="tooltips"--}}
                                    {{--                                                               title="Biaya akan di bebankan kepada customer anda">Biaya--}}
                                    {{--                                                            dibebankan kepada customer anda--}}
                                    {{--                                                            <span class="fa fa-info-circle"></span></label>--}}
                                    {{--                                                        @foreach (\App\Models\ListPayment::with(['companies'=>function($q) use ($company){--}}
                                    {{--                                                        $q->where('id_company',$company->id_company);}])->where('status',1)->get() as $item)--}}
                                    {{--                                                            @if($item->pricing_primary > 0 || $item->pricing_secondary > 0)--}}
                                    {{--                                                                <div class="display-flex mt-2">--}}
                                    {{--                                                                    <label class="mt-2">{{ $item->name_payment }}--}}
                                    {{--                                                                    <span class="ml-1">--}}
                                    {{--                                                                        @if($item->type == 'percentage')--}}
                                    {{--                                                                        ( Fee:--}}
                                    {{--                                                                            @if($item->pricing_primary)--}}
                                    {{--                                                                                {{ $item->pricing_primary }}%--}}
                                    {{--                                                                            @endif--}}
                                    {{--                                                                            @if($item->pricing_secondary > 0)--}}
                                    {{--                                                                                + {{ $item->pricing_secondary }}--}}
                                    {{--                                                                            @endif--}}
                                    {{--                                                                            )--}}
                                    {{--                                                                        @else--}}
                                    {{--                                                                        ( Fee: IDR--}}
                                    {{--                                                                            @if($item->pricing_primary)--}}
                                    {{--                                                                                {{ number_format($item->pricing_primary,0) }}--}}
                                    {{--                                                                            @endif--}}
                                    {{--                                                                            @if($item->pricing_secondary > 0)--}}
                                    {{--                                                                            + {{ number_format($item->pricing_secondary,0) }}--}}
                                    {{--                                                                            @endif--}}
                                    {{--                                                                            )--}}
                                    {{--                                                                        @endif--}}
                                    {{--                                                                    </span>--}}
                                    ...
                                    {{--                                                                        <input type="checkbox" name="listpayment[]"--}}
                                    {{--                                                                               value="{{ $item->id }}"--}}
                                    {{--                                                                        @if($item->companies->count() > 0 && $item->companies->first()->pivot->charge_to == '1')--}}
                                    {{--                                                                            checked--}}
                                    {{--                                                                        @endif--}}
                                    {{--                                                                        >--}}
                                ...
                                @if ($list_payment->status == 1)
                                    ...
                                    <div class="request-bca {{  optional($company->transfer_manual)->status == 'approved' ? '' : 'display-none' }}">
                                        ...
                                        <div class="custom-control custom-checkbox custom-control-inline form-check mb-3 show-for-bca" style="display: none">
                                            <input id="use_data" type="checkbox" name="use_data" class="custom-control-input" />
                        ...
                        <div class="widget card password" id="operator-settings">
                            <div class="widget-header widget-collapse" id="header-operator-settings-password"
                                ...
                                <h3 class="tooltips" title="{{ trans('setting_provider.password_tooltip') }}">
                                    {{ trans('setting_provider.security_information') }}
                                    <span class="fa fa-info-circle"></span></h3>
                                    ...
                                    <div class="form-group">
                                        <div class="form-with-icon">
                                            ...
                                            <input type="password"
                                                ...
                                                class="form-control" name="password" id="password" maxlength="16" autocomplete="new-password">
                ...
                <div class="dashboard-cta float-right">
                    <button id="btn-submit" class="btn btn-primary btn-cta step2" type="submit" name="action" id="save"
                        onclick="onJSButtonclick()">{{ trans('setting_provider.submit') }}
                    </button>
                    <a class="btn btn-primary btn-cta" href="http://{{ $company->domain_memoria }}"
