...
<!-- Main sidebar -->
<div class="sidebar sidebar-light sidebar-main sidebar-expand-md shadow-none">
        ...
        <div data-template="side_navbar">
            ...
            <div class="sidebar-user-material">
                ...
                <div class="card-body text-center">
                    ...
                    @endif
                    <h6 class="mb-0 mt-1 text-dark">{{$company->company_name}}</h6>
                </div>
                </div>
            </div>
            <!-- /user menu -->
            ...
            <div class="card card-sidebar-mobile">
                ...
                <li class="nav-item">
                    <a href="{{ Route('company.insurance.index') }}" class="nav-link {{ Request::is('company.insurance.index') ? 'active' : '' }}">
