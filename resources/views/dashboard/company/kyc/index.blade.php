            ...
            <div class="col">
                <div id="front_page_kyc" class="widget card kyc-front-page {{ auth()->user()->company->kyc ? 'd-none' : '' }}">
                    <div class="widget-content m-3">
                        <div class="img-fluid w-100 text-center">
                            <img src="{{ asset('dest-operator/img/upgrade-premium.png') }}" alt="premium" class="img-fluid premium-image">
                        </div>
                        ...
                        <div class="row mb-2">
                            <div class="col-auto">
                                <img src="{{ asset('dest-operator/img/green-star.png') }}" alt="" class="kyc-front-image-list mt-1">
                            </div>
                            <div class="col">
                        ...
                        <div class="row mb-2">
                            <div class="col-auto">
                                <img src="{{ asset('dest-operator/img/green-card.png') }}" alt="" class="kyc-front-image-list mt-1">
                            </div>
                            <div class="col">
                        ...
                        <div class="row mb-2">
                            <div class="col-auto">
                                <img src="{{ asset('dest-operator/img/green-person.png') }}" alt="" class="kyc-front-image-list mt-1">
                            </div>
                            <div class="col">
                        ...
                        <div class="row">
                            <div class="col text-center">
                                <button type="button" class="btn btn-primary mt-3" id="next_to_complete_form">{!! trans('kyc.front-page.complete_now') !!}</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div id="kyc_success" class="widget card kyc-success-page d-none">
                    <div class="widget-content m-3">
                        ...
                        <div class="row">
                            <div class="col text-center">
                                <a href="{{ route('company.dashboard') }}" class="btn btn-primary mt-3" id="back_to_dashboard">{!! trans('kyc.submit_success.button') !!}</a>
                            </div>
                        </div>
                    </div>
                </div>
