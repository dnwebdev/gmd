...
<table cellpadding="5" cellspacing="0" style="border-collapse:collapse;width: 680px;margin: auto;">
    ...
    <tr>
        <td colspan="3">
            ...
            <p>
                Thank you for ordering on {{ $company->company_name }}. Your order has been confirmed. Please make
                payment immediately according to the invoice that we attach to this email.
            </p>
        </td>
    </tr>
    <tr>
...
<table cellpadding="5" cellspacing="0" style="border-collapse:collapse;width: 680px;margin: auto;">
    ...
    <tr>
        <td colspan="3">
            ...
            <p>
                Terima kasih sudah memesan di {{ $company->company_name }}. Pemesanan Anda sudah dikonfirmasi. Mohon
                segera lakukan pembayaran sesuai dengan invoice yang kami lampirkan pada email ini.
            </p>
        </td>
    </tr>
    <tr>
