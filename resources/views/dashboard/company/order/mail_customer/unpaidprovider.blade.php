                ...
                <table style="padding: 5px 0;width: 100%;">
                    ...
                    @if($order->order_detail->fee_amount > 0)
                        <tr>
                            ...
                            <td style="padding: 5px 15px;" align="right"><strong>IDR <span style="">{{ number_format($order->order_detail->fee_amount,0) }}</span></strong></td>
                        </tr>
                    @endif
                        {{-- Fee Credit card --}}
                    @if($order->fee_credit_card >0)
                        <tr>
                            ...
                            <td style="padding: 5px 15px;" align="right"><strong>IDR <span style="">{{ number_format($order->fee_credit_card,0) }}</span></strong></td>
                        </tr>
                    @endif
                    ...
                    @if($order->fee >0)
                        <tr>
                            ...
                            <td style="padding: 5px 15px;" align="right"><strong>IDR <span style="">{{ number_format($order->fee,0) }}</span></strong></td>
                        </tr>
                    @endif
                    ...
                    @if($order->order_detail->discount_amount > 0)
                        <tr>
                            ...
                            <td style="padding: 5px 15px;" align="right"><strong>IDR <span style="">-{{ number_format($order->product_discount,0) }}</span></strong></td>
                        </tr>
                    @endif
                    ...
                    @if($order->voucher_amount > 0)
                        <tr>
                            ...
                            <td style="padding: 5px 15px;" align="right"><strong>IDR <span style="">-{{ number_format($order->voucher_amount,0) }}</span></strong></td>
                        </tr>
                    @endif
           ...
           <td colspan="3">
                <table style="padding: 5px 0;width: 100%;">
                    ...
                    <tr>
                        ...
                        <td style="padding: 5px 15px;" align="right"><strong>IDR <span style="">{{ number_format($order->total_amount,0) }}</span></strong></td>
                    </tr>
                </table>
           </td>
        </tr>
