                ...
                <table cellpadding="5" cellspacing="0" style="height: 100px;width: 680px;">
                    ...
                    @foreach($order->invoice_detail as $item)
                        <tr>
                            ...
                            <td style="padding:5px 15px;text-align: center;">{{ $item['qty'] }}</td>
                            <td style="padding:5px 15px;" align="right">{{ number_format($item['price'],0) }}</td>
...
<table cellpadding="5" cellspacing="0" style="border-collapse:collapse;width: 680px; margin: auto;">
    <tbody>
        ...
        <tr>
            <td colspan="3">
                <table class="details" cellpadding="5" cellspacing="0" style="height: 100px;width: 680px;">
                    <thead>
                        <tr style="background-color: rgb(239,247,254);text-align: center;">
