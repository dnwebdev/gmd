...
<table cellpadding="5" cellspacing="0" style="border-collapse:collapse; margin: auto; width: 680px;">
		...
		<td colspan="3">
			<table class=" padding" style="width: 100%;">
				...
				@if($order->order_detail->fee_amount > 0)
					<tr>
						<td style="padding-left:  1.2rem!important;width: 69%;">Charge </td>
	...
	<tr>
		...
		@if($order->guides->count() > 0)
			<tr>
				<td colspan="3">
					<table class=" padding" style="width: 100%; padding: 15px;">
						<thead>
...
<table cellpadding="5" cellspacing="0" style="border-collapse:collapse; margin: auto; width: 680px;">
	...
	<tr>
		<td colspan="3">
			<table class=" padding" style="width: 100%;">
				...
				@if($order->order_detail->fee_amount > 0)
					<tr>
						<td style="padding-left:  1.2rem!important;width: 69%;">Biaya </td>
						<td><strong style="display: inline-flex;">IDR <span style="float: right;padding-right: 10px;">{{ number_format($order->order_detail->fee_amount,0) }}</span></strong></td>
					</tr>
				@endif
	...
	<tr>
		<td colspan="3" style="height: 15px;">
			<label style="color: rgb(59,70,80);font-weight: bold;">INFORMASI PEMANDU</label>
		</td>
	</tr>
	@if($order->guides->count() > 0)
		<tr>
	...
	<tr>
		<td colspan="3" style="padding-top: 3rem;">
			<p>Terima kasih telah menggunakan mygomodo.com untuk mempermudah transkasi Anda.<br>
				Powered by Gomodo</p>
		</td>
	</tr>
