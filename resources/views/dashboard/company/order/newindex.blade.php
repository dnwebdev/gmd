...
@section('additionalStyle')
    ...
    <link href="{{ asset('dest-operator/css/order_provider.css') }}" rel="stylesheet">
    <style>
            ...
            <div class="modal-dialog modal-dialog-centered modal-xs" role="document">
                ...
                <div class="modal-content col">
                    ...
                    <div class="modal-footer justify-content-center">
                        ...
                        <button class="btn modal-trigger btn-sm btn-primary" >{{__('offline_invoice.cancel.yes')}}</button>
                    </div>
                </div>
            </div>
        </form>
...
@section('additionalScript')
    ...
    <!-- Theme JS files -->
	<script src="{{ asset('dest-operator/reskin_global_assets/js/plugins/tables/datatables/datatables.min.js') }}"></script>
	<script src="{{ asset('dest-operator/reskin_global_assets/js/plugins/tables/datatables/extensions/responsive.min.js') }}"></script>
	<script src="{{ asset('dest-operator/reskin_global_assets/js/plugins/forms/selects/select2.min.js') }}"></script>
    <script src="{{ asset('dest-operator/reskin_global_assets/js/demo_pages/datatables_responsive.js') }}"></script>

	<script src="{{ asset('dest-operator/reskin_global_assets/js/plugins/loaders/progressbar.min.js') }}"></script>

	<script src="{{ asset('dest-operator/reskin_global_assets/js/demo_pages/components_progress.js') }}"></script>
    <!-- /theme JS files -->
    <script>
