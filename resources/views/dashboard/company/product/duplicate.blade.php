...
@section('title', trans('product_provider.duplicate_product'))
@section('additionalStyle')
    ...
    <link href="{{ asset('dest-operator/css/product_edit.css') }}" rel="stylesheet">
    ...
    <div class="page-header" style="margin-bottom: 0;">
        <div class="page-header-content header-elements-md-inline">
            <div class="page-title">
                <h5>
                    {{-- <i class="icon-pushpin mr-2"></i> --}}  {{ trans('product_provider.duplicate_product') }}
            ...
            <div class="header-elements py-0">
                <div class="breadcrumb">
                    ...
                    <a href="{{ Route('company.product.index') }}" class="breadcrumb-item">
                        <i class="icon-home2 mr-2"></i> {{ trans('sidebar_provider.product') }}
                    </a>
                    <span class="breadcrumb-item active">{{ trans('product_provider.duplicate_product') }}</span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div data-template="widget">
        ...
        <div class="product">
            <form id="form_ajax" method="POST"
                    action="{{ Route('company.product.duplicate',$product->id_product) }}"
...
{{--                        <input type="hidden" name="_method" id="_method" value="PUT">--}}
                ...
                <!-- <div class="dashboard-cta">
                    <button id="btn-submit" class="btn btn-primary btn-cta" type="submit" name="action"  id="save" onclick="tinyMCE.triggerSave(true,true);" >Submit</button>
                    <button class="btn btn-primary btn-cta" type="button" name="preview" id="preview" >Preview</button>
                </div> -->
                                        ...
                                        <select name="country" id="country_search" class="select2-product form-control"
                                            ...
                                            @foreach (App\Models\Country::all() as $item)
                                                <option value="{{ $item->id_country }}"
                                                        @if ($item->id_country == $product->city->state->country->id_country)
                                                        selected
                                                        @endif
                    ...
                    <div class="widget-content">
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6">
                                <div class="form-group select-icon-dropdown">
                                    ...
                                    <select name="availability" id="availability" class="form-control">
                                        <option value="1" {{ $product->availability == 0 ? '' : 'selected' }}>{{ trans('product_provider.always_available') }}</option>
                                        <option value="0" {{ $product->availability == 0 ? 'selected' : '' }}>{{ trans('product_provider.fixed_dates') }}</option>
                                    </select>
                                    <i class="fa fa-chevron-down"></i>
                                </div>
                            </div>
                            <div class="col-sm-12 col-md-12 col-lg-6 col-xl-6 mb-20" id="day_fix">
                                <div class="form-group">
                                    <label for="availability">{{ trans('product_provider.select_day') }}</label>
                                    ...
                                    <div class="col-{{ $product->availability == 0 ? '12' : 'md-6' }}">
                                        <div class="input-field start_label">
                                            <label for="start_date"
                                                    id="tgl">{{ trans('product_provider.start_date') }}</label>
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" name="price_type" type="radio" value="" id="fixed_price">
                                    ...
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" name="price_type" type="radio" value="" id="price_tier">
                            ...
                            <div class="row custom-input-clone" data-custom-index="{{ $loop->index }}">
                                <div class="col-sm-12 mb-3">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-4">
                                            <label for="custom-type" class="tooltips" title="{{ trans('product_provider.custom_required_by_tooltip') }}">{{ trans('product_provider.custom_required_by') }} <span class="fa fa-info-circle fs-14"></span></label><br />
                                        ...
                                        <div class="col-sm-2">
                                            <button type="button" class="btn btn-primary btn-sm btn-add add_custom_input mt-40  small" style="display: {{ $loop->iteration == $loop->count ? 'block' : 'none' }}">
                        ...
                        <div class="row added-on">
                            <div class="col-sm-12 col-md-6 mt-1">
                                ...
                                <div class="form-check form-check-switchery">
                                    ...
                                    <label class="form-check-label">
                                        <input type="checkbox" class="form-check-input-switchery-primary" data-fouc id="addon1" name="addon1" {{ ($product->addon1 === 1) ? 'checked'.' '.'value=1' : '' }}>
                                ...
                                <div class="form-check form-check-switchery">
                                    ...
                                    <label class="form-check-label" id="foot-included">
                                        <input type="checkbox" class="form-check-input-switchery-primary" data-fouc id="addon2" name="addon2" {{ ($product->addon2 === 1) ? 'checked'.' '.'value=1' : '' }}>
                                ...
                                <div class="form-check form-check-switchery">
                                    ...
                                    <label class="form-check-label" id="foot-included">
                                        <input type="checkbox" class="form-check-input-switchery-primary" data-fouc id="addon5" name="addon5" {{ ($product->addon5 === 1) ? 'checked'.' '.'value=1' : '' }}>
                                ...
                                <div class="form-check form-check-switchery">
                                    ...
                                    <label class="form-check-label" id="foot-included">
                                        <input type="checkbox" class="form-check-input-switchery-primary" data-fouc id="addon6" name="addon6" {{ ($product->addon6 === 1) ? 'checked'.' '.'value=1' : '' }}>
                ...
                <div class="row">
                    <div class="dashboard-cta col text-right">
                        <button id="btn-submit" class="btn btn-primary btn-cta step4" type="button" name="action" id="save" data-submit="{{trans('product_provider.submit')}}"
                            onclick="tinyMCE.triggerSave(true,true);">{{ trans('product_provider.submit') }}</button>
                            {{-- @if (\App\Models\Ota::where('ota_status', true)->exists())
                            <button id="btn-show-ota" class="btn btn-primary btn-cta step4" type="button" name="show-ota"
                        ...
                        @else
                            ...
                            onclick="tinyMCE.triggerSave(true,true);">{{ trans('product_provider.submit') }}</button>
                        @endif  --}}
{{--                                <button class="btn btn-primary btn-cta" type="button" name="preview"--}}
{{--                                        id="preview">{{ trans('product_provider.preview') }}</button>--}}
                ...
                @if (\App\Models\Ota::where('ota_status', true)->exists())
                    ...
                    @include('dashboard.company.product.ota_modal', ['data' => $product->ota->pluck('id'), 'approved' => $product->ota->where('pivot.status', 1)->pluck('id'), 'rejected' => $product->ota->where('pivot.status', 2)->pluck('id')])
                @endif
            </form>
        </div>
    </div>
...
{{--    <script src="{{ asset('js/sweetalert2.all.min.js') }}"></script>--}}
    ...
    <script>
        ...
        let endyear = new Date(new Date().setFullYear(new Date().getFullYear() + 5)).getFullYear();
        ...
        jQuery(document).ready(function () {
            ...
            jQuery(document).on('change','#availability',function () {
                ...
                availability(dateVal);
            });

            function availability(avail) {
                if (avail == 0) {
                    ...
                    jQuery('.start_label').parent().removeClass('col-md-6').addClass('col-12');
                    jQuery('input[name="start_date[0]"]').attr('readonly',false).attr('disabled',false).prop('disabled',false).prop('readonly',false)
                } else {
                    jQuery('.listdate').show();
        ...
        $(document).ready(function () {
            ...
            {{--// @endif--}}
            $(document)
                .on('changeDate','input[name="start_date[0]"]', function (e) {
        ...
        function dayCount() {
            ...
            // })
            if ($('select[name=availability]').val()==='1'){
                $('.date-picker').datepicker('destroy').datepicker({
                    startDate : '+1',
                    format: 'mm/dd/yyyy',
                    autoclose: true,
