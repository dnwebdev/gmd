        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="ota-footer text-center mt-3">
                    <button id="btn-submit" class="btn btn-primary btn-cta step4" type="button" name="action" id="save" data-submit="{{trans('product_provider.submit')}}">{{ trans('product_provider.submit') }}</button>
