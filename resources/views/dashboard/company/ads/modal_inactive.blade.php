<!-- MODAL INACTIVE ADS -->
<div class="modal fade modal-ads modal-inactive-ads" id="modal-inactive" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                ...
                <span id="status-inactive">{{trans('premium.modal-order.inactive')}}</span>
            </div>
...
{{--                        </tr>--}}
                ...
                <table class="detail-ordering table table-borderless">
                    ...
                    <tr>
                        <th class="static-order-ads" scope="row" id="category_ads">Facebook Ads</th>
            ...
            <div class="text-center">
                {{-- <button class="btn btn-primary" style="border-radius: 5px;">Extend this product</button> --}}
            </div>
        </div>
    </div>
</div>