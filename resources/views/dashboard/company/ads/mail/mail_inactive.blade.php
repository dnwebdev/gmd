...
<table  align="center" width="680px" cellpadding="5" cellspacing="0">
    <tbody>
        ...
        <tr>
            <td colspan="3">
                <br>
                <p>Kami ingin memberitahukan bahwa masa aktif iklan Anda akan berakhir pada {{ $end_date }}. Report hasil iklan Anda akan kami kirimkan maksimal H+3 setelah iklan anda berakhir. Klik <a href="{{ baseUrl('company/premium') }}" target="_blank">disini</a> untuk memperpanjang masa aktif iklan. Jika terdapat pertanyaan dapat menghubungi kami pada nomor <a class="link" href="https://api.whatsapp.com/send?phone=6281211119655&text=&source=&data=" target="_blank" style="font-weight: bold">+62 812-1111-9655</a></p>
