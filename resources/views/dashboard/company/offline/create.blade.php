                            ...
                            <div class="box-body">
                                ...
                                <div class="parent-form-add">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-1">
                                            <div class="md-form __parent_form">
                                                <button type="button" class="btn btn-primary btn-sm btn-add-detail float-right" ><i class="fa fa-plus f-small"></i></button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-12">
                                            <div class="footer-product">
                                                <div class="col-sm-auto float-right">
                                                    <button class="btn btn-primary f-small btn-block" id="toStep2">{{ trans('offline_invoice.page-1.next') }}<i class="fa fa-chevron-right f-small"></i></button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="box-kayiz mt-3">
                                <div class="box-body">
                                    <div class="row footer-product">
                                        ...
                                        <div class="col-lg-auto float-right">
                                            <button class="btn btn-primary f-small btn-block" id="toStep3"><img
                                                        class="mail-send"
