...
<head>
    ...
    <link href="{{ asset('dest-operator/lib/css/jquery-ui.min.css') }}" rel="stylesheet">
    <link rel="stylesheet"
    ...
    <link rel="stylesheet" href="{{ asset('css/tooltipster-sideTip-noir.min.css')}}">
    <link rel="stylesheet" href="{{ asset('css/introjs.css')}}">
    <link rel="stylesheet" href="{{asset('css/gmap.css')}}">
    <link rel="stylesheet" type="text/css" href="{{ asset('dest-operator/lib/css/jquery.dataTables.css') }}">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/toastr.js/latest/css/toastr.css">
    <link rel="stylesheet" href="https://fonts.googleapis.com/icon?family=Material+Icons">
    <link href="{{asset('css/jquery-fab-button-custome.css')}}" rel="stylesheet">

    <!-- Global stylesheets -->
    <link href="https://fonts.googleapis.com/css?family=Roboto:400,300,100,500,700,900" rel="stylesheet" type="text/css">
    <link href="{{ asset('dest-operator/reskin_global_assets/css/icons/icomoon/styles.min.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('dest-operator/reskin-assets/css/bootstrap.min.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('dest-operator/reskin-assets/css/bootstrap_limitless.min.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('dest-operator/reskin-assets/css/layout.min.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('dest-operator/reskin-assets/css/components.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('dest-operator/reskin-assets/css/colors.min.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('materialize/js/plugins/dropify/css/dropify.min.css') }}" type="text/css" rel="stylesheet" media="screen,projection">
    <link href="{{ asset('dest-operator/reskin-assets/css/slick.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('dest-operator/reskin-assets/css/slick-theme.css') }}" rel="stylesheet" type="text/css">
    <!-- /global stylesheets -->

    <!-- Custome CSS Files -->
    <link rel="stylesheet" href="{{ asset('css/floating-help.css') }}">
    ...
    {{-- <script src="{{ asset('dest-operator/reskin_global_assets/js/main/jquery.min.js') }}"></script> --}}
    <script src="{{ asset('dest-operator/reskin_global_assets/js/main/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ asset('dest-operator/reskin_global_assets/js/plugins/loaders/blockui.min.js') }}"></script>
    <script src="{{ asset('dest-operator/reskin_global_assets/js/plugins/ui/ripple.min.js') }}"></script>
    <!-- /core JS files -->

    <!-- Theme JS files -->
    <script type="text/javascript" src="//cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.js"></script>
    <script src="{{ asset('dest-operator/reskin_global_assets/js/plugins/forms/inputs/inputmask.js') }}"></script>
	<script src="{{ asset('dest-operator/reskin_global_assets/js/plugins/forms/selects/bootstrap_multiselect.js') }}"></script>
	<script src="{{ asset('dest-operator/reskin_global_assets/js/plugins/extensions/jquery_ui/core.min.js') }}"></script>
	<script src="{{ asset('dest-operator/reskin_global_assets/js/plugins/forms/tags/tagsinput.min.js') }}"></script>
	<script src="{{ asset('dest-operator/reskin_global_assets/js/plugins/forms/tags/tokenfield.min.js') }}"></script>
	<script src="{{ asset('dest-operator/reskin_global_assets/js/plugins/forms/inputs/maxlength.min.js') }}"></script>
    <script src="{{ asset('dest-operator/reskin_global_assets/js/plugins/forms/inputs/formatter.min.js') }}"></script>
	<script src="{{ asset('dest-operator/reskin_global_assets/js/plugins/extensions/cookie.js') }}"></script>
    
    <script src="{{ asset('dest-operator/reskin_global_assets/js/demo_pages/form_floating_labels.js') }}"></script>
    <script src="{{ asset('dest-operator/reskin_global_assets/js/demo_pages/form_validation_custome.js') }}"></script>
	<script src="{{ asset('dest-operator/reskin-assets/js/app.js') }}"></script>
    <!-- /theme JS files -->

    <!-- Custome JS Files -->
    <script src="{{ asset('dest-operator/reskin-assets/js/custom.js') }}"></script>
    <!-- /custome JS Files -->
    @if(env('APP_ENV') == 'production')
        @include('analytics')
    @endif
    @yield('additionalStyle')
    <link href="{{ asset('dest-operator/css/index.css') }}" type="text/css" rel="stylesheet">
</head>
<body>
{{-- Loading --}}
<div class="loading">
...
<!-- top bar -->
<div data-template="top_bar">@include('dashboard.company.top_bar')</div>
<!-- end top bar -->
<!-- Page content -->
<div class="page-content">
      ...
      <div class="sidebar sidebar-light sidebar-main sidebar-expand-md">
          ...
          <div class="sidebar-content sidebar-fixed">
              ...
              <!-- Sidebar nav -->
              <div data-template="side_navbar">@include('dashboard.company.sidebar_layout')</div>
              <!-- /sidebar nav -->
      ...
      <div class="content-wrapper">
                        ...
                        <ul>
                            ...
                            <li style="margin-bottom: 5px">
                                <a class="btn-floating bg-indigo btn-large" href="https://medium.com/gomodo" target="_blank">
                                    <img src="{{ asset('dest-operator/img/medium.png') }}">
                                </a>
          ...
          <!-- Footer -->
          <footer data-template="footer" class="footer">@include('dashboard.company.footer')</footer>
      <!-- /footer -->
      </div>
...
<script type="text/javascript" src="{{asset('dest-operator/lib/js/bootstrap-datepicker.id.js')}}"
...
<script src="{{ asset('dest-operator/lib/js/jquery.dataTables.js') }}"></script>
...
<script type="text/javascript" src="{{ asset('materialize/js/custom-script.js') }}"></script>
    <!-- Gamification -->
<script src="{{ asset('dest-operator/reskin_global_assets/js/plugins/extensions/jquery_ui/interactions.min.js') }}"></script>
<script src="{{ asset('dest-operator/reskin_global_assets/js/plugins/notifications/sweet_alert.min.js') }}"></script>
<script src="{{ asset('dest-operator/reskin_global_assets/js/plugins/forms/selects/select2.min.js') }}"></script>
<script src="{{ asset('dest-operator/reskin_global_assets/js/plugins/forms/validation/validate.min.js') }}"></script>
<script src="{{ asset('dest-operator/reskin_global_assets/js/plugins/forms/inputs/touchspin.min.js') }}"></script>
<script src="{{ asset('dest-operator/reskin_global_assets/js/plugins/forms/styling/switch.min.js') }}"></script>
<script src="{{ asset('dest-operator/reskin_global_assets/js/plugins/forms/styling/switchery.min.js') }}"></script>
<script src="{{ asset('dest-operator/reskin_global_assets/js/plugins/forms/styling/uniform.min.js') }}"></script>
<script src="{{ asset('dest-operator/reskin_global_assets/js/plugins/uploaders/dropzone.min.js') }}"></script>
...
<script src="{{ asset('dest-operator/reskin_global_assets/js/demo_pages/form_select2.js') }}"></script>
<script src="{{ asset('dest-operator/reskin_global_assets/js/demo_pages/uploader_dropzone.js') }}"></script>
...
<script>
    ...
    $('#country_search_gamification').on('change', function () {
        var country = $('#country_search_gamification').val();
