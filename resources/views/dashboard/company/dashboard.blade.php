...
@section('content')
    ...
    <div class="content pt-0" dashboard>
        ...
        <!-- /kyc-gamification -->
        <!-- Banner Sugestion -->
        <div data-template="banner-sugetion">@include('dashboard.company.add-on.banner-sugetion')</div>
        <!-- /banner Sugestion -->
        <div data-template="widget">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-xl-12">
                                            ...
                                            <span class="badge rounded-circle badge-icon p-0">
                                                ...
                                                <a href="{{ route('company.withdraw.index') }}"
                                                   class="btn btn-primary legitRipple withdrawBtn mt-2">
                                        ...
                                        <div class="col-lg-6 col-xl-12">
                                            ...
                                            <div class="card card-body mb-0">
                                                <div class="media">
                                                    <div class="media-body text-right">
                                                        <h6 class="font-weight-semibold mb-0 tooltips"
                                                    ...
                                                    @foreach($topViewed as $row)
                                                        <tr>
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <div>
                                                                        <a href="{{route('company.product.edit',['id'=>$row->id_product])}}"
                                                                           class="font-weight-semibold">{{$row->product_name}}</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            @if($row->city)
                                                            ...
                                                            <td>
                                                                ...
                                                                <span class="badge btn-primary"> {{$row->order_detail_count}} {{__('dashboard_provider.booked')}}</span>
                                    ...
                                    <!-- top product empty state -->
                                        <div class="order_empty_state">
                                            <div class="empty_state_content">
                                                <img src="{{ asset('dest-operator/reskin-assets/img/empty_order.svg')}}"/>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade show active" id="highlighted-justified-tab1">
                                                ...
                                                <table class="table text-nowrap">
                                                    ...
                                                    @foreach($upcoming_book as $row)
                                                        <tr>
                                                                ...
                                                                <div class="d-flex align-items-center">
                                                                    <div>
                                                                        <a href="{{route('company.order.edit',['id'=>$row->invoice_no])}}"
                                                                           class="font-weight-semibold">{{$row->order_detail->product_name}}</a>
                                                                    </div>
                                                                </div>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                @if($row->is_read==0)
                                                                    <span class="badge btn-primary">{{trans('dashboard_provider.unread')}}</span>
                                                                @endif
                                                            </td>
                                                            <td class="text-center">
                                                                <div class="list-icons">
                                    ...
                                    <!-- order empty state -->
                                        <div class="order_empty_state">
                                            <div class="empty_state_content">
                                                <img src="{{ asset('dest-operator/reskin-assets/img/empty_guest.svg')}}"/>
                                                <p class="empty_state_copy">
            ...
            <div class="row latest-articles">
                <div class="col-xl-9">
                    <div class="card">
                        <div class="card-header font-weight-bold">
                            <h2>{{ trans('article.latest_articles') }}</h2>
                        </div>
                        <div class="card-body">
                                    ...
                                    <div class="media flex-column flex-sm-row mt-0 mb-3">
                                        <div class="mr-sm-3 mb-2 mb-sm-0">
                                            <div class="card-img-actions">
                                                <a href="">
                                                    <img src="{{ $blog->image_url }}" class="img-fluid img-preview rounded" alt="">
                                                </a>
                                            </div>
                                        </div>

                                        <div class="media-body">
                                        <h6 class="media-title"><a href="{{ route('company.blog.index', ['slug'=>$blog->slug]) }}">{{ $blog->title }}</a></h6>
