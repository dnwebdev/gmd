...
@section('subheader')
    <div class="d-flex align-items-center">
        <div class="mr-auto">
            <h3 class="m-subheader__title ">Edit Press Releases</h3>
        </div>
        ...
        <div class="m-portlet__body ">
            <div class="row ">
                <div class="col-12">
                    ...
                    <div class="form-group">
                        <label for="category">Category Press Releases</label>
                        <select name="category_blog_id" class="form-control" id="category">
                            <option selected disabled>- Select Category Press Releases -</option>
                        ...
                        <div class="col-md-4 mb-5">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <input type="file" name="image_blog" style="visibility:hidden" onchange="openFile(event)" accept="image/*">
                                </div>
                            </div>
                        </div>
                    </div>
