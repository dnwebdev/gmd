...
@section('content')
        ...
        <div class="m-portlet__body  ">
            <div class="row ">
                <div class="col-12 mb-3 text-right">
                    <button id="btn-add" type="button" class="btn btn-sm btn-brand"><i class="fa fa-plus"></i> Add Category</button>
                </div>
                <div class="col-12">
    ...
    <div class="modal fade" id="modal-add" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">Add new Blog Category</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <div class="form-group">
                        {!! Form::label('category_name_ind','Category Name (Ind)') !!}
                        {!! Form::text('category_name_ind',null,['class'=>'form-control','id'=>'category_name_ind','autocomplete'=>'off']) !!}
                    </div>
                    <div class="form-group">
                        {!! Form::label('category_name_eng','Category Name (Eng)') !!}
                        {!! Form::text('category_name_eng',null,['class'=>'form-control','id'=>'category_name_eng','autocomplete'=>'off']) !!}
                    </div>
                </div>
    ...
    <script>
        let dt = $('#dt').dataTable({
            ...
            "columns": [
                ...
                {
                    "data": "category_name_ind", "orderable": true, "searchable": true
                },
                {
                    "data": "category_name_eng", "orderable": true, "searchable": true
                },
                {
                    "data": "action",
                    "class": "text-center"
        ...
        $(document).on('click','.btn-preview', function () {
            ...
            modal.find('input[name=id]').val(btn.data('id'));
            modal.find('input[name=category_name_ind]').val(btn.data('category_name_ind'));
            modal.find('input[name=category_name_eng]').val(btn.data('category_name_eng'));
            modal.modal();
        });
