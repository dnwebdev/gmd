...
@section('subheader')
    <div class="d-flex align-items-center">
        <div class="mr-auto">
            <h3 class="m-subheader__title ">Add OTA</h3>
        </div>
        ...
        <div class="m-portlet__body  ">
            <div class="row ">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        {!! Form::label('ota_slug') !!}
                        {!! Form::text('',null,['id'=>'ota_slug','class'=>'form-control readonly','disabled']) !!}
                        {!! Form::hidden('ota_slug', null, ['id' => 'ota_slug_hidden']) !!}
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('ota_status',['0'=>'Inactive','1'=>'Active'],1,['id'=>'ota_status','class'=>'form-control readonly','readonly']) !!}
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                    ...
                    <div class="preview">
                        <img id="output" src="http://placehold.it/150" alt="" class="img-fluid">
                    </div>
                </div>
