...
@section('subheader')
    <div class="d-flex align-items-center">
        <div class="mr-auto">
            <h3 class="m-subheader__title ">Promo Code</h3>
        </div>
...
@section('content')
        ...
        <div class="m-portlet__body  ">
            <div class="row ">
                <div class="col-12 mb-3 text-right">
                    <a id="btn-add"  href="{{route('admin:premium.promo-code.add')}}" class="btn btn-sm btn-brand"><i class="fa fa-plus"></i> Add Promo Code</a>
                </div>
                <div class="col-12">
    ...
    <div class="modal fade" id="modal-delete" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            {!! Form::open(['url'=>route('admin:premium.promo-code.delete'),'style'=>'width:100%']) !!}
...
@section('scripts')
    ...
    <script>
        let dt = $('#dt').dataTable({
            ...
            "responsive": true,
            "ajax": {
                url: "{{route('admin:premium.promo-code.data')}}",
                type: "GET",
            },
            "columns": [
                {
