...
@section('content')
    <div class="m-portlet">
        <div class="m-portlet__body  ">
            <div class="row ">
                <div class="col-6">
                    {!! Form::open(['files'=>true,'url'=>route('admin:hhbk-distribution.import')]) !!}
                    <div class="form-group">
                        <label for="upload list product baru">Import From Excell <a href="/example/HHBKTrans.xlsx"> <i>Contoh file</i></a></label>
                ...
                <div class="col-6 align-self-end">
                    <div class="d-flex justify-content-end">
                        <a href="{{route('admin:hhbk-distribution.add')}}" class="btn btn-sm btn-primary" type="button"><i class="fa fa-plus"></i> Tambah</a>
                    </div>
                </div>
            </div>
        </div>
...
@section('scripts')
    ...
    <script>
        let dt = $('#myTable').dataTable({
            ...
            "responsive": true,
            "ajax": {
                url: "{{route('admin:hhbk-distribution.data')}}",
                type: "GET",
            },
            "columns": [
                {
