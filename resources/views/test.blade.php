                            ...
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <div class="input-group">
                                        <input class="form-control" type="text" id="api-key" placeholder="API Key" value="xnd_public_development_OYqIfOUth+GowsY6LeJOHzLCZtSj84J9kXDn+Rxj/mbf/LCoCQdxgA=="/>
                ...
                <div class="panel panel-default credit-card-box">
                    ...
                    <div class="panel-body">
                        <div class="row json">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <label for="meta-json">JSON:</label>
                                    <textarea class="form-control" rows="5" id="meta-json">{}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group col-xs-6">
                                    <div class="input-group">
                                        Enable Meta
                                        <input class="form-control" type="checkbox" id="should-use-meta"/>
                                    </div>
                                </div>
                            </div>
                        </div>
