...
{{--                <i class="icon-spinner11 icon-2x text-primary border-primary-primary border-3 rounded-round p-3 mb-3 mt-1"></i>--}}
            ...
            <button class="btn bg-primary btn-block next" type="button" id="submitButton" onclick="submitData()" disabled>
