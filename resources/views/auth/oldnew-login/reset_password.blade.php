...
@section('content')
    ...
    <h3 class="text-center">{{ trans('landing.register.register_otp') }}</h3>
        ...
        <div class="form-group">
            ...
            <div class="form-group">
                <button class="next btn btn-primary" type="button" onclick="submitData()"
                        data-validation="{{trans('landing.register.activation_reset_password')}}"
                        disabled>{{trans('landing.register.create_new_password')}}</button>
            </div>
        </div>
    </form>
@stop
