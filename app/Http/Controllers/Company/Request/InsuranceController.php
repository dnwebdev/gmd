...
class InsuranceController extends Controller
{
    public function save(Request $request)
    {
        ...
        if ($companyRequest = InsuranceRequest::where('company_id', auth()->user()->company->id_company)->where('status','!=', 'reject')->first()) {
            return apiResponse(403,trans('insurance.form.already_exists'));
        }
